...
url = 'https://en.wikipedia.org/wiki/Category:Song_recordings_produced_by_Paul_McCartney'
url2 = 'https://en.wikipedia.org/w/index.php?title=Category:Song_recordings_produced_by_Paul_McCartney&pagefrom=Off+the+Ground+%28song%29#mw-pages'
...
df3.to_csv('mccartney_as_producer.csv')
